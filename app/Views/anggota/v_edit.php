            ...
            <div class="card-body">
                <form action="" method="post" id="formsave">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" style="text-transform: uppercase;" value="<?= $data['nama']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="telp" id="telp" class="form-control" value="<?= $data['telp']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="telp_kerabat" id="telp_kerabat" class="form-control" value="<?= $data['telp_kerabat']; ?>">
                        <div class="invalid-feedback error_telp_kerabat">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea name="alamat" id="alamat" rows="2" class="form-control"><?= $data['alamat']; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kamar" id="id_kamar" class="form-control select2bs4">
                            ...
                            <?php foreach ($kamar as $k) : ?>
                                <option value="<?= $k['id']; ?>" <?= $data['id_kamar'] == $k['id'] ? 'selected' : ""; ?>><?= $k['nama']; ?> - (Rp <?= number_format($k['harga'], 0, ",", "."); ?> / bulan)</option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_kost" id="tgl_kost" class="form-control" value="<?= $data['tgl_kost']; ?>" required readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_sewa" id="jenis_sewa" class="form-control">
                            <option value="bulanan" <?= $data['jenis_sewa'] == 'bulanan' ? 'selected' : ""; ?>>Per bulan</option>
                            <option value="3 bulan" <?= $data['jenis_sewa'] == '3 bulan' ? 'selected' : ""; ?>>Per 3 bulan</option>
                            <option value="1 tahun" <?= $data['jenis_sewa'] == '1 tahun' ? 'selected' : ""; ?>>Per 1 tahun</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="2" class="form-control"><?= $data['keterangan']; ?></textarea>
