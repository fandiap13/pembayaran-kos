        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <a href="<?= base_url('kamar?status=tersedia'); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-6">
                <!-- small box -->
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h4 class="font-weight-bold"><?= $total_kamar_dipakai; ?> Orang</h4>

                        <p>Total Kamar Dipakai</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-house-user"></i>
                    </div>
                    <a href="<?= base_url('kamar?status=tidak tersedia'); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
